...
function initMap() {
    ...
    map = L.map('map', {
        center: window.innerWidth <= 768 ? [48.81826349423801, 1.62] : [48.81826349423801, 1.6032443265782088],
        zoom: window.innerWidth <= 768 ? 10.5 : 11,
        zoomControl: false,
        maxZoom: 20,
    ...
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: 'Hébergement : <a href="https://informatique-m2i.fr/">M2i informatique </a>,Cartographie : <a href="https://www.linkedin.com/in/alexandreponchon/">Alexandre PONCHON </a> , <a href="https://www.openstreetmap.fr/">OSM</a>, iconographie : <a href="https://www.flaticon.com/fr/">Flaticon</a>'
    }).addTo(map);
